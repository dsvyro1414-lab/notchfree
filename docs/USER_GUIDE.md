...
Direct integrations wait half a second between playback checks while the selected player is running, or two seconds while it is closed. The system Now Playing integration receives updates directly.
